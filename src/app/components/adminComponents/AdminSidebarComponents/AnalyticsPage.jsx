...
const AnalyticsPage = () => {
  ...
  const stats = [
    { icon: "👥", value: "1,247", label: "Daily Active Users", trend: "+8.3%", trendUp: true, bg: "bg-primary/10" },
    { icon: "⏱️", value: "4m 32s", label: "Avg Session", trend: "+12%", trendUp: true, bg: "bg-cyan-500/10" },
    { icon: "📱", value: "84%", label: "Mobile Users", trend: "+5%", trendUp: true, bg: "bg-purple-500/10" },
    { icon: "🔄", value: "68%", label: "Retention (30d)", trend: "+3%", trendUp: true, bg: "bg-amber-500/10" }
  ];
  ...
  const topDivisions = [
    { name: "Dhaka", percentage: 62, color: "#059669" },
    { name: "Chattogram", percentage: 18, color: "#0891b2" },
    { name: "Sylhet", percentage: 9, color: "#f59e0b" },
    { name: "Others", percentage: 11, color: "#8b5cf6" }
  ];

  const dauData = {
    labels: ["May 23", "24", "25", "26", "27", "28", "29", "30", "31", "Jun 1", "2", "3", "4", "5"],
    values: [980, 1050, 1120, 1090, 1180, 1240, 1200, 1310, 1280, 1380, 1290, 1420, 1380, 1247]
  };

  const trafficData = {
    labels: ["Organic", "Referral", "Direct"],
    values: [52, 28, 20],
    colors: ["#059669", "#0891b2", "#8b5cf6"]
  };
  ...
  return (
    <div>
      ...
      <div className="grid lg:grid-cols-2 gap-5 mb-5">
        ...
        {/* Traffic Sources Chart */}
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="font-bold text-foreground mb-4">🔵 Traffic Sources</div>
          <div className="h-64 relative">
